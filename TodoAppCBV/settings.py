"""
Django settings for TodoAppCBV project.
...
SECRET_KEY = 'django-insecure-p%$r^#0f$ei@8^hc$w$iju@a8-hz@t44c=g8j!5121^4fzy%x2'
...
WSGI_APPLICATION = 'TodoAppCBV.wsgi.application'
